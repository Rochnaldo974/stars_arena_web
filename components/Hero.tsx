    ...
    <div className='pb-20 pt-36'>
        <div>
          <Spotlight
            ...
            fill="rgba(138, 43, 226, 0.8)" // Bleu-violet
          />
          <Spotlight
            className='-top-10 left-full h-[80vh] w-[50vw]'
            fill="rgba(186, 85, 211, 0.8)" // Orchidée moyen
          />
          <Spotlight
            className='top-28 left-80 h-[80vh] w-[50vw]'
            fill="rgba(153, 50, 204, 0.8)" // Violet foncé
          />
        </div>
      ...
      <div className='flex justify-center relative my-20 z-10'>
        ...
        lg:max-w-[60vw] flex flex-col items-center justify-center'>
          ...
          mb-4 text-sm md:text-lg lg:text-2xl'>
            Présentez vos talents, gagnez des trophées et des récompenses dans des compétitions de musique passionnante
          </p>
